...
public class Schedule extends AppCompatActivity {
    ...
    private void setupCourses(EditText[][] courses) {
        ...
        String dummy = "m1;m2;m3;m4;m5;m6;m7;m8;m9; ;d2;d3;d4;d5;d6;d7;d8; ;w1;w2;w3;w4;w5;w6;w7;w8;w9;d1;d2;d3;d4;d5;d6;d7;d8;d9;v1;v2;v3;v4;v5;v6;v7;v8;v9";
        String[] dummy2 = dummy.split(";");

        //courses:
        for (int i = 0, j = 0; i < dummy2.length; i++, j = i / 9) {
            if (!courses[j][i % 9].equals(" ")) {//space means no data...
