...
/**
 * Created by Daan Reynders on 7/11/2017.
 */
...
public class GoogleCalenderAPI extends AppCompatActivity implements EasyPermissions.PermissionCallbacks { //verwijder Activity
       ...
       @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mCallApiButton = (Button) findViewById(R.id.call_Button);
            ...
            mOutputText = (TextView) findViewById(R.id.outputext);
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            GoogleCalenderAPI.REQUEST_AUTHORIZATION);
                } else {
